    ...
    return (
        ...
        <TextInput style={styles.input} placeholder="Nombre de la pelicula" placeholderTextColor="#aaa" />
        <View style={styles.horizontalContainer}>
            <TextInput style={styles.smallInput} placeholder="Duracion" placeholderTextColor="#aaa" />
            <TextInput style={styles.smallInput} placeholder="Director" placeholderTextColor="#aaa" />
        </View>
